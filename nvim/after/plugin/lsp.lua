...
local function on_attach(_, buffer)
   ...
   vim.keymap.set('n', '<leader>gk', function() vim.lsp.buf.code_action() end, options)
   vim.keymap.set('n', '<leader>gs', function() vim.lsp.buf.workspace_symbol() end, options)
   vim.keymap.set('n', '<leader>gf', function() vim.diagnostic.open_float() end, options)
